    ...
    ?>
                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <h3 class="no-margins">GHC<?php echo number_format((float) $tot_fee ,2); ?> </h3>
                                <small> </small> 
						  </div>
                        </div>
                    </div>             
...
<div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <h3 class="no-margins">GHC<?php echo number_format((float) $tot_pay ,2); ?></h3>
                                <small> </small> 
						  </div>
                        </div>
                    </div>    
...
<?php echo "Pending"; ?></div>
	  <?php } ?> </h3>
                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <h3 class="no-margins">GHC<?php echo number_format((float) $outstanding_fee ,2); ?>  </h3>
                                <small> </small> 
						  </div>
                        </div>
                    </div>             
