    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div>
            <div>
                ...
                <h5 class="style3">CKT-UTAS ONLINE CLEARANCE SYSTEM</h5>
                <h1 class="logo-name"><a href="index.php"><img src="images/logo.jpeg" alt="onlineclearance" width="200" height="111" border="0"></a></h1>
            </div>
           
            <form class="m-t" role="form" method= "POST" action="">
                <div class="form-group">
                    <input type="text" name="txtmatric_no" class="form-control" placeholder="Stundent ID" required="">
                </div>
                <div class="form-group">
