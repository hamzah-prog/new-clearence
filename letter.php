...
<head>
    ...
    <title>Clearance Letter |CKT-UTAS CLEARANCE</title>
                    ...
                    <div class="ibox">
                        <div class="ibox-content">
                          <div class="text-center article-title">
                            ...
                            <h1 class="logo-name"><a href="index.php"><img src="images/logo.jpeg" alt="onlineclearance" width="180" height="100" border="0"></a></h1>
                            <h1>
                                    CKT-UTAS CLEARANCE FORM <img src="<?php echo $rowaccess['photo']; ?>" width="157" height="175"></h1>
                          </div>
                            ...
                            <p align="justify"><strong>STUDENT ID:</strong> <?php echo $rowaccess['matric_no']; ?></p>
                            ...
                            <p align="justify">&nbsp;</p>
                            <p align="justify">
                                This letter will allow you process for convocation and National Service Schene (NSS) and any other if need arise. we wish you best of luck.</p>
