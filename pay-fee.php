                    ...
                    <div class="ibox-content">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <p class="text-center style1"><strong>SCHOOL FEES :</strong>    <span class="badge badge-info">GHC<?php echo number_format((float) $tot_fee ,2); ?></span></p>
                                <p class="text-center style1"><strong>TOTAL PAID :</strong>  <span class="badge badge-warning">GHC<?php echo number_format((float) $tot_pay ,2); ?></span>   </p>
                                <p class="text-center style1"><strong>OUTSTANDING FEE :</strong>  <span class="badge badge-primary">GHC<?php echo number_format((float) $outstanding_fee ,2); ?></span>   </p>
